...
export default function CardBlog({ blog }) {
    return (
        <article className="flex flex-col items-start justify-between max-w-xl p-6 bg-white shadow-lg rounded-3xl">
            <img src={blog.photo_cover} alt={blog.tag_blog} className="object-cover w-full mb-2 h-44 rounded-xl"/>
            ...
            <div className="relative flex items-center mt-8 gap-x-4">
                <img src={blog.foto} alt={blog.username} className="object-cover w-10 h-10 rounded-full bg-gray-50" loading="lazy" />
