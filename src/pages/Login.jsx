...
export default function Login() {
    ...
    return (
        <div className="flex flex-col justify-center flex-1 min-h-full px-6 py-12 lg:px-8 lg:py-40">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div className="mt-10 text-sm text-center text-gray-900">
                    <p>----------------------- <span className="font-bold">Or continue with</span> -----------------------</p>
                </div>
                <div>
                    <button
